...
export function WebLayout({ sidebar, topbar, children }: Props) {
  return (
    <div className="min-h-screen bg-[var(--bg)] text-[var(--text)]">
      ...
      <div className="flex min-h-screen flex-col lg:ml-[312px]">
        <header className="sticky top-0 z-30 shrink-0 border-b border-white/10 bg-[var(--bg-soft)]/80 backdrop-blur-xl">
          {topbar}
        </header>
